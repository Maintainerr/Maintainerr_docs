...
- For qBittorrent and Transmission, if **Delete downloaded data** is on and another torrent shares the same downloaded files, Maintainerr removes only the torrent entry and keeps the data so the other torrent keeps working.
