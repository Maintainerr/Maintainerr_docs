...
<div className="doc-button-row">
  <Link className="button button--primary" to="/rules">
    Rules
  </Link>
...
If you would like help understanding your Test Media output, you can use the Maintainerr Discord bot.

Use the slash command `/maintainerr bot` in Discord. The bot will send you a direct message.

From there, paste the output from Test Media into the DM. The bot will then break down the results for you and help explain what the output means.

This can be useful when a result is large, hard to read, or when you want a quicker explanation of why a rule matched or did not match.
