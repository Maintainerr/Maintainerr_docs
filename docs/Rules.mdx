...
If you prefer to manage Plex collections yourself or use a different tool, you can enable the `Custom collection` option. This uses a manually managed collection, so Maintainerr will not automatically create and delete that collection in Plex.
