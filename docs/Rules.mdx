...
If you prefer to manage Plex collections yourself or use a different tool, you can enable the `Custom collection` option. With this enabled, Maintainerr links the rule group to an existing collection instead of creating and deleting that collection in Plex itself.
