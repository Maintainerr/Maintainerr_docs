...
| Custom collection name      | The name of the existing custom collection to use <InlineTooltip label="+" tooltip="Only shown and needed when the Custom Collection checkbox is checked." />                                                                                                                                                                                                                                                                                                                                                         |
...
If you prefer to manage Plex collections yourself or use a different tool, you can enable the custom collection option. With this enabled, Maintainerr will not automatically create and delete that collection in Plex.
