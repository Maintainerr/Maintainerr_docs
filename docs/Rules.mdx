...
- `Watch time by user (minutes)` counts every minute played, not only finished views. The view count and last view date still use each integration's watched-percentage setting.
