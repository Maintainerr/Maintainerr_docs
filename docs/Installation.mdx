...
Compose is recommended for most installs. Define the Maintainerr service in your docker-compose.yml as follows.
      ...
      containers:
        - name: maintainerr
          ...
          env:
            ...
            # - name: BASE_PATH      # uncomment if serving from a subdirectory
            #   value: /maintainerr
          volumeMounts:
            - name: data
              mountPath: /opt/data
