...
:::info
Indicates whether the league or selected season has an event scheduled in the future. Sportarr uses an event's broadcast date when available, otherwise its event date. Any scheduled event counts, whether monitored or not.
:::
