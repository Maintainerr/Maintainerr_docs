...
[Link to see how to get your Plex media info and XML data](https://support.plex.tv/articles/201998867-investigate-media-information-and-formats/#:~:text=Open%20the%20Media,the%20XML%20information)
:::
...
![Rule setup screen](/img/screenshot-1.png)
...
![Plex collection example](/img/screenshot_plex_collection.png)
...
![Additional rule settings](/img/screenshot-2.png)
...
- 11: It is recommended to keep this option off as it uses an outdated method. Maintainerr now automatically does this.
...
![Discord example](/img/screenshot_discord_comment.png)
...
Take a look at this page for the proper syntax of each parameter: [Rules Glossary](/glossary).
:::
...
This is a very good jumping off point for you to start making rules. If you are still not 100% confident yet, or just want more, take a look at [S01E02](/blog/rule-creation-s01e02) and go even deeper down the rabbit hole.
