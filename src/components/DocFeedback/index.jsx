...
export default function DocFeedback() {
  ...
  return (
    <div className={styles.feedback}>
      ...
      {selection === "helpful" && (
        <p className={styles.note}>Thanks for the feedback.</p>
      )}
      {selection === "improve" && (
        <p className={styles.note}>
          Thanks for the feedback. Help us improve this page by opening an issue
          in the <a href={issueUrl}>docs repo</a>.
        </p>
      )}
    </div>
  );
