    ...
    <div className={styles.banner} role="dialog" aria-live="polite" aria-label="Cookie consent">
      <div className={styles.content}>
        ...
        <p className={styles.copy}>
          We use privacy-friendly analytics to understand which docs are useful and where people
          get stuck. You can read the full policy at{' '}
          <a href={privacyPolicyUrl}>Maintainerr Privacy Policy</a>.
        </p>
      </div>
      <div className={styles.actions}>
        <button className="button button--primary button--sm" onClick={() => updateConsent('accepted')}>
          Accept
        </button>
        <button className="button button--secondary button--sm" onClick={() => updateConsent('rejected')}>
          Reject
        </button>
      </div>
    </div>
